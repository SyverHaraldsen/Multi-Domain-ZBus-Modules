...
#warning                                                                                           \
	"CONFIG_MDM_LED_MASTER is set, this application is the owner of the LED module, and the runner is the listener."
#else
#define MDM_LED_CHANNEL_IS_LISTENER 1
#warning                                                                                           \
	"CONFIG_MDM_LED_MASTER is NOT set, this application is the listener of the LED module, and the runner is the owner."
#endif
