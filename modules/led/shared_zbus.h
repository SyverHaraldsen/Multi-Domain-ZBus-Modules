 ...
 */
  ...
  * The runner application should set CONFIG_MDM_LED=y and CONFIG_MDM_LED_MASTER=y
  * in the prj.conf file of the application.
 */
...
#if IS_ENABLED(CONFIG_MDM_LED_OWNER)
#define MDM_LED_IS_LISTENER 0
#warning "CONFIG_MDM_LED_MASTER is set, this application is the owner of the LED module, and the runner is the listener."
#else
#define MDM_LED_IS_LISTENER 1
#warning "CONFIG_MDM_LED_MASTER is NOT set, this application is the listener of the LED module, and the runner is the owner."
#endif
...
ZBUS_MULTIDOMAIN_CHAN_DEFINE(LED_CHAN,
                             ...
                             ZBUS_MSG_INIT(0),
                             MDM_LED_IS_LISTENER,        // Runner is listener
